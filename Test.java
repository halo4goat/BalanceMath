...
public class Test extends JFrame {
    ...
    public Test() {
        ...
        JLabel title = new JLabel("Test", SwingConstants.CENTER);
    ...
    private BigInteger calculateValue(BigInteger x, BigInteger y) {
    ...
    private void calculate() {
        try {
            BigInteger x = read(a);
            BigInteger y = read(b);
            answer.setText(calculateValue(x, y).toString());
